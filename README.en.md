...
https://github.com/jojowink/jojo-claw-office-ui/blob/master/SKILL.md
```
...
```bash
# 1) Clone the repo
git clone https://github.com/jojowink/jojo-claw-office-ui.git
cd Star-Office-UI
...
6. **AI-Powered Room Design** — Connect your own Seedream API to generate new office backgrounds; core features work fine without an API
...
| `GET /config/gemini` | Get Seedream API config |
| `POST /config/gemini` | Set Seedream API config |
...
[![Star History Chart](https://api.star-history.com/image?repos=jojowink/jojo-claw-office-ui&type=date&legend=top-left)](https://www.star-history.com/?repos=jojowink%2Fjojo-claw-office-ui&type=date&legend=top-left)
